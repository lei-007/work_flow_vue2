            ...
            <el-form-item v-for="(condition, cindex) in group.conditions" :key="condition.id + '_' + cindex">
              ...
              <span v-if="condition.valueType === ValueType.string">
                ...
                <span v-else style="margin-left: 10px">
                  <el-input v-if="condition.compare === '='" style="width: 280px;" placeholder="输入比较值" size="small"
              ...
              <span v-else-if="condition.valueType === ValueType.number">
                ...
                <span style="margin-left: 10px">
                  <el-input style="width: 280px;" v-if="conditionValType(condition.compare) === 0" size="small"
                    placeholder="输入比较值" type="number" v-model="condition.value[0]" />
                  <el-select style="width: 280px;" multiple filterable allow-create
                    v-else-if="conditionValType(condition.compare) === 1" size="small" v-model="condition.value"
                    placeholder="输入可能包含的值"></el-select>
                  <span v-else>
                    <el-input style="width: 130px;" size="small" type="number" placeholder="输入比较值"
                      v-model="condition.value[0]" />
                    <span> ~
                      <el-input size="small" style="width: 130px;" type="number" placeholder="输入比较值"
              ...
              <span v-else-if="condition.valueType === ValueType.user">
                ...
                <el-button size="mini" icon="el-icon-plus" type="primary" @click="selectUser(condition.value, 'user')"
              ...
              <span v-else-if="condition.valueType === ValueType.dept">
                ...
                <el-button size="mini" icon="el-icon-plus" type="primary" @click="selectUser(condition.value, 'dept')"
...
import OrgItems from '@/components/processTree/OrgItems.vue'
