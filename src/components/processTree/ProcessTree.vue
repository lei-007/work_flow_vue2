<script>
//导入所有节点组件
import Approval from '@/components/processNode/ApprovalNode.vue'
import Cc from '@/components/processNode/CcNode.vue'
import Concurrent from '@/components/processNode/ConcurrentNode.vue'
import Condition from '@/components/processNode/ConditionNode.vue'
import Trigger from '@/components/processNode/TriggerNode.vue'
import Delay from '@/components/processNode/DelayNode.vue'
import Empty from '@/components/processNode/EmptyNode.vue'
import Root from '@/components/processNode/RootNode.vue'
import Node from '@/components/processNode/Node.vue'
